...
// A worm structure
struct worm {
  int maxindex; //Last usable index into the array pointed by wormpos
  int headindex; // An index into the array of the worms head position
                 // 0 <= headinex <= maxindex
  ...
  enum ColorPairs wcolor; // Color of the worm
};
